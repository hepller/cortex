...
Запрос к API должен выглядеть так: `http://<адрес>:<порт>/qa?question=<текст_запроса>`
...
Пример ошибки *(в данном случае - при отсутствии аргумента `question`)*:
